...
propose improvements; the baseline analyzes and adopts (with human approval) generalized
versions, then disseminates them back. Never change the baseline without a `federation/changelog`
entry and a release bump.
